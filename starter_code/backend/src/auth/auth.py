...
def get_token_auth_header():
    ...
    #in postman, in authorization tab, send Bearer token
    #to access this bearer token, we have to access request.headers['Authorization'] dictionary
    #headers is a dictionary object containing all of the headers 
